...
$ ENCRYPT_TYPES = "Basic,"+ -
		  ...
		  "DES,AES,RC2,RC4,IDEA,BF,CAST,KARM,CAMELLIA,SEED,MODES,"+ -
...
$ LIB_KARM = "cmll_ecb,cmll_ofb,cmll_cfb,cmll_ctr,"+ -
	"cmll_utl,karm,cmll_misc,cmll_cbc"
...
$ LIB_EVP = "encode,digest,evp_enc,evp_key,evp_acnf,evp_cnf,"+ -
	"e_des,e_bf,e_idea,e_des3,e_karm,e_camellia"+ -
