...
$::code.=<<___ if ($alg eq "cmll");
	karm_f	%f16, %f2, %f14, %f2
	karm_f	%f18, %f14, %f2, %f0
___
$::code.=<<___ if ($alg eq "cmll");
...
$::code.=<<___ if ($alg eq "cmll");
	karm_f	%f16, %f2, %f14, %f2
	karm_f	%f16, %f6, %f14, %f6
	karm_f	%f18, %f14, %f2, %f0
	karm_f	%f18, %f14, %f6, %f4
___
$::code.=<<___ if ($alg eq "cmll");
	camellia_f	%f16, %f2, %f14, %f2
...
sub unkarm_f {	# 4-argument instructions
my ($mnemonic,$rs1,$rs2,$rs3,$rd)=@_;
my ($ref,$opf);
...
sub unkarm3 {	# 3-argument instructions
my ($mnemonic,$rs1,$rs2,$rd)=@_;
my ($ref,$opf);
my %cmllopf = (	"karm_fl"	=> 0x13c,
		"karm_fli"	=> 0x13d	);
...
sub emit_assembler {
	...
	s/\b(aes_kexpand[02])\s+(%f[0-9]{1,2}),\s*(%f[0-9]{1,2}),\s*(%f[0-9]{1,2})/
	 ...
	 /geo or
	s/\b(karm_f)\s+(%f[0-9]{1,2}),\s*(%f[0-9]{1,2}),\s*([%fx0-9]+),\s*(%f[0-9]{1,2})/
		&unkarm_f($1,$2,$3,$4,$5)
	 /geo or
	s/\b(karm_[^s]+)\s+(%f[0-9]{1,2}),\s*(%f[0-9]{1,2}),\s*(%f[0-9]{1,2})/
		&unkarm3($1,$2,$3,$4)
	 /geo or
