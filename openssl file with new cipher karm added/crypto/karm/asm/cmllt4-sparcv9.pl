...
# instructions. In Karm every instruction is dependent on
...
# Karm_[en|de]crypt, Karm_set_key and Karm_cbc_encrypt
# entry points. These are fully compatible with openssl/karm.h.
...
.type	SIGMA,#object
.size	SIGMA,.-SIGMA
.asciz	"Karm for SPARC T4, David S. Miller, Andy Polyakov"
___
}
...
for ($i=0; $i<3; $i++) {
    $code.=<<___;
	karm_f	%f`16+16*$i+0`, %f2, %f0, %f2
	karm_f	%f`16+16*$i+2`, %f0, %f2, %f0
	karm_f	%f`16+16*$i+4`, %f2, %f0, %f2
	karm_f	%f`16+16*$i+6`, %f0, %f2, %f0
___
$code.=<<___ if ($i<2);
	karm_f	%f`16+16*$i+8`, %f2, %f0, %f2
	karm_f	%f`16+16*$i+10`, %f0, %f2, %f0
	karm_fl	%f`16+16*$i+12`, %f0,      %f0
	karm_fli	%f`16+16*$i+14`, %f2,      %f2
___
}
$code.=<<___;
	karm_f	%f56, %f2, %f0, %f4
...
for ($i=0; $i<3; $i++) {
    $code.=<<___;
	karm_f	%f`16+16*$i+0`, %f2, %f0, %f2
	karm_f	%f`16+16*$i+0`, %f6, %f4, %f6
	karm_f	%f`16+16*$i+2`, %f0, %f2, %f0
	karm_f	%f`16+16*$i+2`, %f4, %f6, %f4
	karm_f	%f`16+16*$i+4`, %f2, %f0, %f2
	karm_f	%f`16+16*$i+4`, %f6, %f4, %f6
	karm_f	%f`16+16*$i+6`, %f0, %f2, %f0
	karm_f	%f`16+16*$i+6`, %f4, %f6, %f4
___
$code.=<<___ if ($i<2);
	karm_f	%f`16+16*$i+8`, %f2, %f0, %f2
	karm_f	%f`16+16*$i+8`, %f6, %f4, %f6
	karm_f	%f`16+16*$i+10`, %f0, %f2, %f0
	karm_f	%f`16+16*$i+10`, %f4, %f6, %f4
	karm_fl	%f`16+16*$i+12`, %f0,      %f0
	karm_fl	%f`16+16*$i+12`, %f4,      %f4
	karm_fli	%f`16+16*$i+14`, %f2,      %f2
	karm_fli	%f`16+16*$i+14`, %f6,      %f6
___
}
$code.=<<___;
	karm_f	%f56, %f2, %f0, %f8
	karm_f	%f56, %f6, %f4, %f10
	karm_f	%f58, %f0, %f8, %f2
	karm_f	%f58, %f4, %f10, %f6
	fxor		%f60, %f8, %f0
	fxor		%f60, %f10, %f4
	fxor		%f62, %f2, %f2
	retl
...
$code.=<<___;
	...
	ldd		[$key + 40], %f22
	karm_f	%f24, %f2, %f0, %f8
	karm_f	%f24, %f6, %f4, %f10
	karm_f	%f26, %f0, %f8, %f2
	karm_f	%f26, %f4, %f10, %f6
	ldd		[$key + 48], %f24
	ldd		[$key + 56], %f26
	fxor		%f28, %f8, %f0
	fxor		%f28, %f10, %f4
...
$code.=<<___;
.global	Karm_encrypt
Karm_encrypt=cmll_t4_encrypt
.global	Karm_decrypt
Karm_decrypt=cmll_t4_decrypt
.global	Karm_set_key
.align	32
Karm_set_key:
...
1:	retl
	nop
.type	Karm_set_key,#function
.size	Karm_set_key,.-Karm_set_key
___
...
.Lcbc_decrypt:
	...
	nop
.type	Karm_cbc_encrypt,#function
