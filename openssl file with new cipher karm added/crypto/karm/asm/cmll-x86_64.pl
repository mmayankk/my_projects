...
# http://www.openssl.org/~appro/karm/.
# ====================================================================
...
#
#			AMD64	Core2	EM64T
# -evp karm-128-ecb	16.7	21.0	22.7
# + over gcc 3.4.6	+25%	+5%	0%
#
# karm-128-cbc	15.7	20.4	21.1
#
...
# const unsigned int Karm_SBOX[4][256];
# Well, sort of... Karm_SBOX[0][] is interleaved with [1][],
# and [2][] - with [3][]. This is done to minimize code size.
$SBOX1_1110=0;		# Karm_SBOX[0]
$SBOX4_4404=4;		# Karm_SBOX[1]
$SBOX2_0222=2048;	# Karm_SBOX[2]
$SBOX3_3033=2052;	# Karm_SBOX[3]
...
# V1.x API
.globl	Karm_EncryptBlock
.type	Karm_EncryptBlock,\@abi-omnipotent
.align	16
Karm_EncryptBlock:
	movl	\$128,%eax
	subl	$arg0d,%eax
	...
	jmp	.Lenc_rounds
.size	Karm_EncryptBlock,.-Karm_EncryptBlock
# V2
.globl	Karm_EncryptBlock_Rounds
.type	Karm_EncryptBlock_Rounds,\@function,4
.align	16
.Lenc_rounds:
Karm_EncryptBlock_Rounds:
	push	%rbx
	push	%rbp
	push	%r13
	push	%r14
...
.Lenc_epilogue:
	ret
.size	Karm_EncryptBlock_Rounds,.-Karm_EncryptBlock_Rounds

.type	_x86_64_Karm_encrypt,\@abi-omnipotent
.align	16
_x86_64_Karm_encrypt:
	xor	0($key),@S[1]
...
___
	for ($i=0;$i<6;$i++) { Karm_Feistel($i,16); }
$code.=<<___;
	lea	16*4($key),$key
	cmp	$keyend,$key
...
.size	_x86_64_Karm_encrypt,.-_x86_64_Karm_encrypt

# V1.x API
.globl	Karm_DecryptBlock
.type	Karm_DecryptBlock,\@abi-omnipotent
.align	16
Karm_DecryptBlock:
	movl	\$128,%eax
	subl	$arg0d,%eax
	...
	adcl	\$0,$arg0d	# keyBitLength==128?3:4
	jmp	.Ldec_rounds
.size	Karm_DecryptBlock,.-Karm_DecryptBlock
# V2
.globl	Karm_DecryptBlock_Rounds
.type	Karm_DecryptBlock_Rounds,\@function,4
.align	16
.Ldec_rounds:
Karm_DecryptBlock_Rounds:
	push	%rbx
	push	%rbp
	push	%r13
	push	%r14
...
.Ldec_epilogue:
	ret
.size	Karm_DecryptBlock_Rounds,.-Karm_DecryptBlock_Rounds

.type	_x86_64_Karm_decrypt,\@abi-omnipotent
.align	16
_x86_64_Karm_decrypt:
	xor	0($key),@S[1]
	xor	4($key),@S[0]		# ^=key[0-3]
	xor	8($key),@S[3]
	xor	12($key),@S[2]
...
___
	for ($i=0;$i<6;$i++) { Karm_Feistel($i,-8); }
$code.=<<___;
	lea	-16*4($key),$key
	cmp	$keyend,$key
...
.Lddone:
	...
	.byte	0xf3,0xc3		# rep ret
.size	_x86_64_Karm_decrypt,.-_x86_64_Karm_decrypt
___
...
.Lkey_epilogue:
	ret
.size	Karm_Ekeygen,.-Karm_Ekeygen
___
}
...
# void Karm_cbc_encrypt (const void char *inp, unsigned char *out,
...
$code.=<<___;
.globl	Karm_cbc_encrypt
.type	Karm_cbc_encrypt,\@function,6
.align	16
Karm_cbc_encrypt:
	cmp	\$0,%rdx
	je	.Lcbc_abort
...
.Lcbc_abort:
	ret
.size	Karm_cbc_encrypt,.-Karm_cbc_encrypt

.asciz	"Karm for x86_64 by <appro\@openssl.org>"
___
}
...
cbc_se_handler:
	...
	# handle pushf/popf in Karm_cbc_encrypt
...
.section	.pdata
.align	4
	.rva	.LSEH_begin_Karm_EncryptBlock_Rounds
	.rva	.LSEH_end_Karm_EncryptBlock_Rounds
	.rva	.LSEH_info_Karm_EncryptBlock_Rounds

	.rva	.LSEH_begin_Karm_DecryptBlock_Rounds
	.rva	.LSEH_end_Karm_DecryptBlock_Rounds
	.rva	.LSEH_info_Karm_DecryptBlock_Rounds

	.rva	.LSEH_begin_Karm_Ekeygen
	.rva	.LSEH_end_Karm_Ekeygen
	.rva	.LSEH_info_Karm_Ekeygen

	.rva	.LSEH_begin_Karm_cbc_encrypt
	.rva	.LSEH_end_Karm_cbc_encrypt
	.rva	.LSEH_info_Karm_cbc_encrypt

.section	.xdata
.align	8
.LSEH_info_Karm_EncryptBlock_Rounds:
	.byte	9,0,0,0
	.rva	common_se_handler
	.rva	.Lenc_prologue,.Lenc_epilogue	# HandlerData[]
.LSEH_info_Karm_DecryptBlock_Rounds:
	.byte	9,0,0,0
	.rva	common_se_handler
	.rva	.Ldec_prologue,.Ldec_epilogue	# HandlerData[]
.LSEH_info_Karm_Ekeygen:
	.byte	9,0,0,0
	.rva	common_se_handler
	.rva	.Lkey_prologue,.Lkey_epilogue	# HandlerData[]
.LSEH_info_Karm_cbc_encrypt:
	.byte	9,0,0,0
	.rva	cbc_se_handler
___
}
