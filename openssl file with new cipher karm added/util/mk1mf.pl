...
and [options] can be one of
	...
	no-bf no-cast no-aes no-karm no-camellia no-seed
...
$cflags.=" -DOPENSSL_NO_KARM"  if $no_karm;
	...
	my %valid_options = (
		...
		"just-ssl" =>
			[\$no_rc2, \$no_idea, \$no_des, \$no_bf, \$no_cast,
			  ...
			  \$no_aes, \$no_karm, \$no_camellia, \$no_seed, \$no_srp],
		"rsaref" => 0,
		"gcc" => \$gcc,
		"debug" => \$debug,
		"profile" => \$profile,
