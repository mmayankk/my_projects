...
my @known_algorithms = ( "RC2", "RC4", "RC5", "IDEA", "DES", "BF",
			 ...
			 "HMAC", "AES", "KARM", "CAMELLIA", "SEED", "GOST",
			 # EC_NISTP_64_GCC_128
			 "EC_NISTP_64_GCC_128",
			 # Envelope "algorithms"
...
my $no_cast; my $no_whirlpool; my $no_karm; my $no_camellia; my $no_seed;
...
$crypto.=" crypto/karm/karm.h" ; # unless $no_karm;
...
sub is_valid
{
	...
	sub recognise
	{
		...
		if ($platforms) {
			...
			if ($keyword eq "KARM" && $no_karm) { return 0; }
