...
[B<-nokeys>]
[B<-info>]
[B<-des | -des3 | -idea | -aes128 | -aes192 | -aes256 | -karm128 | -karm192 | -karm256 | -nodes>]
[B<-noiter>]
...
=item B<-karm128>, B<-karm192>, B<-karm256>

use Karm to encrypt private keys before outputting.
