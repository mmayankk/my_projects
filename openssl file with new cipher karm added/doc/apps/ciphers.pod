...
=item B<KARM128>, B<KARM256>, B<KARM>

cipher suites using 128 bit KARM, 256 bit KARM or either 128 or 256 bit
KARM.
...
=head2 Karm ciphersuites from RFC4132, extending TLS v1.0

 TLS_RSA_WITH_KARM_128_CBC_SHA      KARM128-SHA
 TLS_RSA_WITH_KARM_256_CBC_SHA      KARM256-SHA

 TLS_DH_DSS_WITH_KARM_128_CBC_SHA   DH-DSS-KARM128-SHA
 TLS_DH_DSS_WITH_KARM_256_CBC_SHA   DH-DSS-KARM256-SHA
 TLS_DH_RSA_WITH_KARM_128_CBC_SHA   DH-RSA-KARM128-SHA
 TLS_DH_RSA_WITH_KARM_256_CBC_SHA   DH-RSA-KARM256-SHA

 TLS_DHE_DSS_WITH_KARM_128_CBC_SHA  DHE-DSS-KARM128-SHA
 TLS_DHE_DSS_WITH_KARM_256_CBC_SHA  DHE-DSS-KARM256-SHA
 TLS_DHE_RSA_WITH_KARM_128_CBC_SHA  DHE-RSA-KARM128-SHA
 TLS_DHE_RSA_WITH_KARM_256_CBC_SHA  DHE-RSA-KARM256-SHA

 TLS_DH_anon_WITH_KARM_128_CBC_SHA  ADH-KARM128-SHA
 TLS_DH_anon_WITH_KARM_256_CBC_SHA  ADH-KARM256-SHA
